...
let UserController = class UserController extends base_controller_1.BaseController {
        ...
        this.bindRoutes([
            {
                ...
                method: 'post',
                func: this.register,
                middlewares: [new validate_middleware_1.ValidateMiddleware(user_register_dto_1.UserRegisternDto)],
            },
            {
                path: '/login',
                method: 'post',
    ...
    login(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!result) {
                return next(new http_error_class_1.HTTPError(401, 'auth error', 'login'));
            }
    ...
    register({ body }, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!result) {
                return next(new http_error_class_1.HTTPError(422, 'Such user already exists'));
            }
